...
class CNN_LSTM_CNN(nn.Module):
    ...
    def forward(self, x, pred_steps):
        ...
        features = features.view(batch_size, seq_len, 128, 8, 8) # (Batch, 10, 8192)
...
state_dict3 = torch.load('/home/oban/Desktop/Volga/MMI711/project/model_convlstm_finetuned_128.pt', weights_only=False)
