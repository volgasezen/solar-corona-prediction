...
state_dict = torch.load('/home/oban/Desktop/Volga/MMI711/project/3-lstm2/model_conv_ae2.pt', weights_only=False)
...
latent_arrays = encode_frames(train_patches, model).reshape(8, 6010, 16, 8, 8)
...
torch.save(model2.state_dict(), '/home/oban/Desktop/Volga/MMI711/project/model_latent_convlstm.pt')
